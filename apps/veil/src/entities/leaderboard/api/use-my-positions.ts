// TODO: We should probably use use-leaderboard and do:
// 1. Get all the positions for the subaccount using use-positions
// 2. Filter the positions by the starting and ending block heights
// 3. Left join this with the leaderboard data from the pindexer
