...
export const NotFoundPage = () => {
  return (
    <div>
      ...
      <section className='h-[calc(100dvh-80px)] max-w-[1062px] flex flex-col items-center justify-center desktop:justify-start gap-6 pt-8 px-4 mx-auto text-neutral-light'>
