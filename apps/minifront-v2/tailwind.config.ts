  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        gradientAccentRadial: 'radial-gradient(100% 100% at 0% 0%, rgba(244, 156, 67, 0.25) 0%, rgba(244, 156, 67, 0.03) 100%)',
        gradientUnshieldRadial: 'radial-gradient(100% 100% at 0% 0%, rgba(193, 166, 204, 0.25) 0%, rgba(193, 166, 204, 0.03) 100%)',
