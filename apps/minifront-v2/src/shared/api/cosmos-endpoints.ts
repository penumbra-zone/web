...
export const isEndpointHealthy = (endpoint: string): boolean => {
...
export const markEndpointFailed = (endpoint: string): void => {
  failedEndpoints.set(endpoint, Date.now());
};

export const getHealthyEndpoints = (chainId: string): string[] => {
