            ...
            {filteredDapps.map((i, index) => (
              ...
              >
                ...
                <Popover>
                  ...
                  <PopoverContent align='center' className='p-0 pb-3 w-[120px]'>
                   <Button variant='outline' className='w-full flex justify-start px-5 h-11'>Delete</Button>
                   <Button variant='outline' className='w-full flex justify-start px-5 h-11'>Edit</Button>
                  </PopoverContent>
                </Popover>
              </div>
            ))}
