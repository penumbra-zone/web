...
const useSaveNumeraireSelector = (state: AllSlices) => ({
    numeraireAssetId: state.numeraire.numeraireAssetId,
    setNumeraireAssetId: state.numeraire.setNumeraireAssetId,
});
