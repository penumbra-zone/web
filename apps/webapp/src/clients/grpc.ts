...
export const viewClient = createPromiseClient(
  ViewProtocolService,
  createChannelTransport(ViewProtocolService),
);

export const custodyClient = createPromiseClient(
  CustodyProtocolService,
  createChannelTransport(CustodyProtocolService),
);

export const simulateClient = createPromiseClient(
  SimulationService,
  createChannelTransport(SimulationService),
);

export const ibcClient = createPromiseClient(
  IbcClientService,
  createChannelTransport(IbcClientService),
);
