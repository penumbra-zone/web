...
## penumbracompat is bech32, not bech32m

For IBC compatibility, we provide a `penumbracompat` address format that is
bech32 instead of bech32m. You can use `penumbracompat` when interacting with
