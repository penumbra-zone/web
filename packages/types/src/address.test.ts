...
describe('isPenumbraAddr()', () => {
  ...
  test('incorrect length returns false', () => {
    const incorrectLengthAddress = 'penumbrav2t147mfall0zr6a';
    expect(isPenumbraAddr(incorrectLengthAddress)).toBeFalsy();
  });

  test('incorrect prefix returns false', () => {
    const incorrectPrefixAddress =
      'lanumbrov2t147mfall0zr6am5r45qkwht7xqqrdsp50czde7empv7yq2nk3z8yyfh9k9520ddgswkmzar22vhz9dwtuem7uxw0qytfpv7lk3q9dp8ccaw2fn5c838rfackazmgf3ahhvhypxd';
