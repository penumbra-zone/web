...
const sheetVariants = cva('fixed z-50 gap-4 bg-background pb-4 pt-5 shadow-lg transition data-[state=open]:duration-500 data-[state=open]:animate-in', {
  variants: {
    side: {
      top: 'inset-x-0 top-0 border-b data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top',
      bottom:
        'inset-x-0 bottom-0 border-t data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom',
      left: 'inset-y-0 left-0 flex h-full w-3/4 flex-col border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left',
      right:
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title ref={ref} className={cn('font-headline text-base text-white', className)} {...props} />
));
