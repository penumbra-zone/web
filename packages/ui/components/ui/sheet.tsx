...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-background pb-4 pt-5 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:fill-mode-forwards data-[state=closed]:fill-mode-forwards',
  {
    variants: {
      side: {
...
>(({ side = 'right', className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetOverlay className='data-[state=closed]:fake-animation'>
