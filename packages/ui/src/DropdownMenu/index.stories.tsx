    ...
    return (
      <DropdownMenu isOpen={isOpen} onClose={() => setIsOpen(false)}>
        <DropdownMenu.Trigger asChild>
          <Button onClick={() => setIsOpen(true)} iconOnly icon={Filter}>Filter</Button>
        ...
        <DropdownMenu.Content>
          ...
          <DropdownMenu.Item actionType='default' disabled>Disabled</DropdownMenu.Item>
        </DropdownMenu.Content>
      </DropdownMenu>
    );
  },
      ...
      <DropdownMenu isOpen={isOpen} onClose={() => setIsOpen(false)}>
        ...
        <DropdownMenu.Content>
          <DropdownMenu.RadioGroup value={value} onValueChange={setValue}>
            <DropdownMenu.RadioItem actionType='destructive' value='1'>Destructive</DropdownMenu.RadioItem>
            <DropdownMenu.RadioItem actionType='accent' value='2'>Accent</DropdownMenu.RadioItem>
            <DropdownMenu.RadioItem actionType='unshield' value='3'>Unshield</DropdownMenu.RadioItem>
            <DropdownMenu.RadioItem actionType='default' value='4'>Default</DropdownMenu.RadioItem>
            <DropdownMenu.RadioItem actionType='default' value='5' disabled>Disabled</DropdownMenu.RadioItem>
