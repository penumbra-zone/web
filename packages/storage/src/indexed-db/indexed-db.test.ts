...
import { base64ToUint8Array, IdbUpdate, PenumbraDb, ScanResult } from '@penumbra-zone/types';
...
const scanResultWithSctUpdates: ScanResult = {
  height: 1092n,
  newNotes: [],
  newSwaps: [],
  sctUpdates: {
...
const denomMetadataC = DenomMetadata.fromJson({
  denom_units: [
    {
      aliases: [],
      denom: 'gn',
...
const transactionInfo = TransactionInfo.fromJson({
  height: '137540',
  id: {
