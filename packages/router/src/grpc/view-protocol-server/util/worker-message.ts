...
import type { InternalMessage } from '@penumbra-zone/types/src/internal-msg/shared';
...
export const isActionBuildRequestMessageEvent = (
  evt: MessageEvent<unknown>,
): evt is MessageEvent<ActionBuildRequest> =>
  evt instanceof MessageEvent && isActionBuildRequest(evt.data);
